...
type Call struct {
	...
	// present if that type has a nested message definition.
	Type             *Call_Type        `protobuf:"varint,2,opt,name=type,enum=mesosproto.Call_Type" json:"type,omitempty"`
	Accept           *Call_Accept      `protobuf:"bytes,3,opt,name=accept" json:"accept,omitempty"`
	Decline          *Call_Decline     `protobuf:"bytes,4,opt,name=decline" json:"decline,omitempty"`
	Kill             *Call_Kill        `protobuf:"bytes,5,opt,name=kill" json:"kill,omitempty"`
	Shutdown         *Call_Shutdown    `protobuf:"bytes,6,opt,name=shutdown" json:"shutdown,omitempty"`
